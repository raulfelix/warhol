...
function add_scripts() {
  ...
  wp_register_style( 'style', get_template_directory_uri() . '/static/dist/css/218681e68386.style.css', null, null, 'all' );

  wp_register_script( 'global', get_template_directory_uri() . '/static/dist/js/11a808572c3f.global.min.js', null, null, true );
  wp_register_script( 'home', get_template_directory_uri() . '/static/dist/js/afb8f9d0eac2.home.min.js', null, null, true );
