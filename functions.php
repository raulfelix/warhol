...
function add_scripts() {
  ...
  wp_register_style( 'style', get_template_directory_uri() . '/static/dist/css/d56d8a60537a.style.css', null, null, 'all' );
  ...
  wp_register_script( 'gallery', get_template_directory_uri() . '/static/dist/js/569865890f9c.gallery.min.js', array('single'), null, true );
