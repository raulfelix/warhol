...
function add_scripts() {
  ...
  wp_register_style( 'style', get_template_directory_uri() . '/static/dist/css/fd27a3ad1b08.style.css', null, null, 'all' );

  wp_register_script( 'global', get_template_directory_uri() . '/static/dist/js/11a808572c3f.global.min.js', null, null, true );
  wp_register_script( 'home', get_template_directory_uri() . '/static/dist/js/75d4cfe2bfaa.home.min.js', null, null, true );
