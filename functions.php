...
function add_scripts() {
  ...
  wp_register_style( 'style', get_template_directory_uri() . '/static/dist/css/7cf0cee1d2de.style.css', null, null, 'all' );
  ...
  wp_register_script( 'single', get_template_directory_uri() . '/static/dist/js/b087095e1e31.single.min.js', null, null, true );
  ...
  wp_register_script( 'bundle', get_template_directory_uri() . '/build/dist/js/499242a75e41.bundle.js', null, null, true );
