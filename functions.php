...
function add_scripts() {
  ...
  wp_register_style( 'style', get_template_directory_uri() . '/static/dist/css/be588133b76f.style.css', null, null, 'all' );
  ...
  wp_register_script( 'single', get_template_directory_uri() . '/build/dist/js/749cec8d6808.single.entry.js', null, null, true );
  wp_register_script( 'everywhere', get_template_directory_uri() . '/build/dist/js/b779e30c54f4.everywhere.entry.js', null, null, true );
  wp_register_script( 'index', get_template_directory_uri() . '/build/dist/js/d004aa510a30.index.entry.js', null, null, true );
