...
function add_scripts() {
  ...
  wp_register_style( 'style', get_template_directory_uri() . '/static/dist/css/d0231f3af044.style.css', null, null, 'all' );
  ...
  wp_register_script( 'gallery', get_template_directory_uri() . '/static/dist/js/b7fa4eead0a6.gallery.min.js', array('single'), null, true );
