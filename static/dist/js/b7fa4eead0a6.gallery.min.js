...
b._c7&&b._c7.css({width:a.width(),height:a.height()})},32)});var c=b._a.mozilla;b.ev.on("rsAfterParseNode",function(d,e,f){if(d=a(e),f.videoURL){b.st.video.disableCSS3inFF&&c&&(b._e=b._f=!1),e=a('<div class="rsVideoContainer"></div>');var g=a('<div class="rsBtnCenterer"><div class="rsPlayBtn"><div class="rsPlayBtnIcon"></div></div></div>');d.hasClass("rsImg")?f.content=e.append(d).append(g):f.content.find(".rsImg").wrap(e).after(g)}}),b.ev.on("rsAfterSlideChange",function(){b.stopVideo()})},toggleVideo:function(){return this._b7?this.stopVideo():this.playVideo()},playVideo:function(){var b=this;if(!b._b7){var c=b.currSlide;if(!c.videoURL)return!1;b._d7=c;var d,e,f=b._e7=c.content,c=c.videoURL;return c.match(/youtu\.be/i)||c.match(/youtube\.com/i)?(e=/^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/,(e=c.match(e))&&11==e[7].length&&(d=e[7]),void 0!==d&&(b._c7=b.st.video.youTubeCode.replace("%id%",d))):c.match(/vimeo\.com/i)&&(e=/(www\.)?vimeo.com\/(\d+)($|\/)/,(e=c.match(e))&&(d=e[2]),void 0!==d&&(b._c7=b.st.video.vimeoCode.replace("%id%",d))),b.videoObj=a(b._c7),b.ev.trigger("rsOnCreateVideoElement",[c]),b.videoObj.length&&(b._c7=a('<div class="rsVideoFrameHolder"><div class="rsPreloader"></div><div class="rsCloseVideoBtn"><div class="rsCloseVideoIcn"></div></div></div>'),b._c7.find(".rsPreloader").after(b.videoObj),f=f.hasClass("rsVideoContainer")?f:f.find(".rsVideoContainer"),b._c7.css({width:f.width(),height:f.height()}).find(".rsCloseVideoBtn").off("click.rsv").on("click.rsv",function(a){return b.stopVideo(),a.preventDefault(),a.stopPropagation(),!1}),f.append(b._c7),b.isIPAD&&f.addClass("rsIOSVideo"),b._f7(!1),setTimeout(function(){b._c7.addClass("rsVideoActive")},10),b.ev.trigger("rsVideoPlay"),b._b7=!0),!0}return!1},stopVideo:function(){var a=this;return a._b7?(a.isIPAD&&a.slider.find(".rsCloseVideoBtn").remove(),a._f7(!0),setTimeout(function(){a.ev.trigger("rsOnDestroyVideoElement",[a.videoObj]);var b=a._c7.find("iframe");if(b.length)try{b.attr("src","")}catch(c){}a._c7.remove(),a._c7=null},16),a.ev.trigger("rsVideoStop"),a._b7=!1,!0):!1},_f7:function(a){var b=[],c=this.st.video;if(c.autoHideArrows&&(this._c2&&(b.push(this._c2,this._d2),this._e2=!a),this._v5&&b.push(this._v5)),c.autoHideControlNav&&this._k5&&b.push(this._k5),c.autoHideBlocks&&this._d7.animBlocks&&b.push(this._d7.animBlocks),c.autoHideCaption&&this.globalCaption&&b.push(this.globalCaption),this.slider[a?"removeClass":"addClass"]("rsVideoPlaying"),b.length)for(c=0;c<b.length;c++)a?b[c].removeClass("rsHidden"):b[c].addClass("rsHidden")}}),a.rsModules.video=a.rsProto._z6}(jQuery),function(a){a.rsProto._g7=function(){var b=this;b.st.visibleNearby&&b.st.visibleNearby.enabled&&(b._h7={enabled:!0,centerArea:.6,center:!0,breakpoint:0,breakpointCenterArea:.8,hiddenOverflow:!0,navigateByCenterClick:!1},b.st.visibleNearby=a.extend({},b._h7,b.st.visibleNearby),b.ev.one("rsAfterPropsSetup",function(){b._i7=b._e1.css("overflow","visible").wrap('<div class="rsVisibleNearbyWrap"></div>').parent(),b.st.visibleNearby.hiddenOverflow||b._i7.css("overflow","visible"),b._o1=b.st.controlsInside?b._i7:b.slider}),b.ev.on("rsAfterSizePropSet",function(){var a,c=b.st.visibleNearby;a=c.breakpoint&&b.width<c.breakpoint?c.breakpointCenterArea:c.centerArea,b._h?(b._b4*=a,b._i7.css({height:b._c4,width:b._b4/a}),b._d=b._b4*(1-a)/2/a):(b._c4*=a,b._i7.css({height:b._c4/a,width:b._b4}),b._d=b._c4*(1-a)/2/a),c.navigateByCenterClick||(b._q=b._h?b._b4:b._c4),c.center&&b._e1.css("margin-"+(b._h?"left":"top"),b._d)}))},a.rsModules.visibleNearby=a.rsProto._g7}(jQuery),this.Handlebars=this.Handlebars||{},this.Handlebars.gallery_inline=Handlebars.template(function(Handlebars,a,b,c,d){function e(a,c){var d,e,g,h="";return h+='\n      <li class="sly-slide header-gallery-overlay" style="width: ',g={hash:{},inverse:i.noop,fn:i.program(2,f,c),data:c},(e=b.getWidth)?d=e.call(a,g):(e=a&&a.getWidth,d=typeof e===j?e.call(a,g):e),b.getWidth||(d=k.call(a,d,{hash:{},inverse:i.noop,fn:i.program(2,f,c),data:c})),(d||0===d)&&(h+=d),h+='px;">\n        ',e=b.loader||a&&a.loader,g={hash:{},inverse:i.noop,fn:i.program(2,f,c),data:c},d=e?e.call(a,null==c||c===!1?c:c.index,g):l.call(a,"loader",null==c||c===!1?c:c.index,g),(d||0===d)&&(h+=d),h+='\n        <div class="m-wrap m-transparent"><img class="m-bg" src="',(e=b.src)?d=e.call(a,{hash:{},data:c}):(e=a&&a.src,d=typeof e===j?e.call(a,{hash:{},data:c}):e),h+=m(d)+'"></div>\n        <div class="blanket"></div>\n      </li>\n    '}function f(){var a="";return a}this.compilerInfo=[4,">= 1.0.0"],b=this.merge(b,Handlebars.helpers),d=d||{};var g,h="",i=this,j="function",k=b.blockHelperMissing,l=b.helperMissing,m=this.escapeExpression;return h+='<div id="inline-gallery-frame" class="header-feature-bg header-gallery-frame frame" >\n  <ul class="slidee">\n    ',g=b.each.call(a,a&&a.inline,{hash:{},inverse:i.noop,fn:i.program(1,e,d),data:d}),(g||0===g)&&(h+=g),h+="\n  </ul>\n</div>"});var Views=window.Namespace("Views");Views.Gallery=function(){function a(){e(function(){d.reload(),c.reload(),b.reload()},200)}var b={state:{modal:void 0,slider:void 0,responsive:{height:120,heightTouch:160},startTime:0,previousPosition:0},elements:{$imgs:void 0,$total:void 0,$home:void 0},init:function(){b.state.startTime=(new Date).getTime(),void 0===b.state.slider&&(b.elements.$slider=$("#modal-gallery-frame .royalSlider"),b.elements.$imgs=b.elements.$slider.find("img"),b.elements.$total=b.state.modal.el().find(".modal-gallery-count"),b.elements.$home=b.state.modal.el().find("#modal-gallery-home"),b.state.modal.el().find(".sly-prev").click(b.prev),b.state.modal.el().find(".sly-next").click(b.next),b.setModalRowHeight(),b.state.slider=b.elements.$slider.royalSlider({keyboardNavEnabled:!0,sliderDrag:!1,navigateByClick:!1,transitionSpeed:260,startSlideId:0,controlNavigation:"none",fadeinLoadedSlide:!1,globalCaption:!0,addActiveClass:!0,arrowsNav:!1}).data("royalSlider"),b.state.slider.ev.on("rsAfterSlideChange",function(){ga("send","event","Gallery","click","Gallery modal navigate",{page:location.pathName}),b.onActivate(b.state.slider.currSlideId)}),b.onActivate(0),b.elements.$imgs.each(function(){imagesLoaded(this,function(a){$(a.elements[0]).removeClass("m-transparent").next().remove()})}),b.elements.$home.click(function(){b.state.slider.goTo(0),b.onActivate(0)}))},destroy:function(){var a=(new Date).getTime();ga("send","timing","Gallery","Modal view",a-b.state.startTime,"Gallery modal",{page:location.pathName})},next:function(){b.state.slider.next()},prev:function(){b.state.slider.prev()},onActivate:function(a){b.elements.$total.html(a+1+" / "+b.state.slider.numSlides),0!==a&&b.state.previousPosition>a?b.elements.$home.addClass("gallery-home-active"):0===a&&b.elements.$home.removeClass("gallery-home-active"),b.state.previousPosition=a},setModalRowHeight:function(){var a=LWA.Modules.Util.getResponsive().BP1.match()?b.state.responsive.heightTouch:b.state.responsive.height;b.elements.$slider.css("height",LWA.Modules.Util.windowHeight()-a),b.elements.$slider.find(".rsOverflow").css("height",LWA.Modules.Util.windowHeight()-a)},clearDimensions:function(){b.elements.$slider.height("auto").width(LWA.Modules.Util.windowWidth());for(var a=$(document.createDocumentFragment()),c=0;c<b.state.slider.slides.length;c++)b.state.slider.slides[c].content.find("img").removeClass("modal-gallery-height modal-gallery-width"),a.append(b.state.slider.slides[c].content);b.elements.$slider.children().remove(),b.elements.$slider.append(a)},reload:function(){if(void 0!==b.state.slider){b.state.modal.loader.start();var a=b.state.slider.currSlideId;b.clearDimensions(),b.state.slider.destroy(),b.state.slider=void 0,b.setModalRowHeight(),b.state.slider=b.elements.$slider.royalSlider({keyboardNavEnabled:!0,sliderDrag:!1,navigateByClick:!1,transitionSpeed:260,startSlideId:a,controlNavigation:"none",fadeinLoadedSlide:!1,globalCaption:!0,addActiveClass:!0,arrowsNav:!1}).data("royalSlider"),b.state.slider.ev.on("rsAfterSlideChange",function(){b.onActivate(b.state.slider.currSlideId)}),b.onActivate(a),setTimeout(function(){b.state.modal.loader.stop()},1e3)}}},c={state:{sly:void 0},elements:{$header:$(".header")},toggle:function(){c.elements.$header.toggleClass("header-gallery-thumbs-active")},init:function(){$("#header-gallery-thumbs");c.initialiseSly($("#header-gallery-thumbs")),$("#gallery-thumbs").click(c.toggle)},initialiseSly:function(a){c.state.sly=new Sly("#header-gallery-thumbs",{horizontal:1,itemNav:"basic",smart:1,activateOn:"click",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,speed:300,elasticBounds:1,easing:"swing",prevPage:a.find(".sly-prev"),nextPage:a.find(".sly-next")}),c.state.sly.init(),c.state.sly.on("active",c.onActivate)},onActivate:function(a,b){d.setActive(b)},setActive:function(a){c.state.sly.activate(a)},reload:function(){c.state.sly.reload()}},d={element:{title:$(".header-gallery-title"),overlay:$("#header-gallery .m-overlay"),gallery:$("#header-gallery-wrap"),home:$("#inline-gallery-home")},state:{sly:void 0,responsive:void 0,isTouch:!1,loader:!1,previousPosition:0},template:Handlebars.gallery_inline,init:function(){this.state.responsive=LWA.Modules.Util.getResponsive(),this.state.isTouch=!this.state.responsive.BP3.match(),this.state.loader=LWA.Modules.Spinner("#header-gallery .loader-icon",{show:!0}),this.element.title.on("webkitTransitionEnd transitionend msTransitionEnd oTransitionEnd",d.onTransitionEnd),Handlebars.registerHelper("getWidth",function(){return Math.round(this.width*(748/this.height))}),Handlebars.registerHelper("loader",function(a){return a>1?'<div class="loader-icon"><i class="icon-reload"></i></div>':void 0}),d.element.home.click(function(){d.state.sly.activate(0)}),this.chooseRendering(this.state.loader)},chooseRendering:function(a){this.state.responsive.BP3.match()&&this.state.isTouch!==!0?(this.renderFeature(),LWA.Modules.Loader({imageContent:"#tmpl-gallery-images",hiddenContent:"#header-gallery .m-wrap",loader:a}),this.state.isTouch=!0):this.state.responsive.BP3.match()||this.state.isTouch!==!0||(d.renderGallery(),setTimeout(function(){$("#header-gallery-wrap").removeClass("m-transparent"),d.state.loader.destroy()},2e3),this.state.isTouch=!1)},initialiseSlider:function(){var a=$("#inline-gallery-controls");d.state.sly=new Sly("#inline-gallery-frame",{horizontal:1,itemNav:"centered",smart:1,activateOn:"click",touchDragging:1,releaseSwing:1,startAt:0,speed:300,elasticBounds:1,easing:"swing",prev:a.find(".sly-prev"),next:a.find(".sly-next")}),d.state.sly.init(),d.state.sly.on("active",d.onActivate)},renderGallery:function(){var a=$("#tmpl-gallery-images").html(this.template(LWA.Data.Gallery));a.find("img").each(function(){imagesLoaded(this,function(a){$(a.elements[0]).closest("div").removeClass("m-transparent").prev().remove()})}),d.element.overlay.hide(),d.initialiseSlider()},renderFeature:function(){$("#tmpl-gallery-images").css("background-image","url("+LWA.Data.Gallery.feature+")").addClass("header-feature-bg"),d.element.overlay.show(),d.showTitle()},destroyFeature:function(){$("#tmpl-gallery-images").css("background-image","none").removeClass("header-feature-bg")},destroyGallery:function(){$("#tmpl-gallery-images").html(""),d.state.sly.destroy()},onActivate:function(a,b){ga("send","event","Gallery","click","Gallery inline navigate",{page:location.pathName}),c.setActive(b),d.state.previousPosition>b&&!d.element.home.hasClass("gallery-home-active")&&d.element.home.addClass("gallery-home-active"),!d.element.gallery.hasClass("animate-gallery")&&b>=1?d.hideTitle():d.element.gallery.hasClass("animate-gallery")&&0===b&&d.showTitle(),d.state.previousPosition=b},showTitle:function(){d.element.home.removeClass("gallery-home-active"),d.element.title.css("display",""),setTimeout(function(){d.element.gallery.removeClass("animate-gallery")},200)},hideTitle:function(){d.element.gallery.addClass("animate-gallery")},onTransitionEnd:function(){d.element.gallery.hasClass("animate-gallery")&&d.element.title.css("display","none")},setActive:function(a){d.state.sly.activate(a)},reload:function(){this.state.responsive.BP3.match()&&this.state.isTouch!==!0?(this.destroyGallery(),this.renderFeature(),this.state.isTouch=!0):this.state.responsive.BP3.match()||this.state.isTouch!==!0?this.state.isTouch===!1&&this.state.sly.reload():(this.destroyFeature(),this.renderGallery(),this.state.isTouch=!1)}},e=function(){var a=0;return function(b,c){clearTimeout(a),a=setTimeout(b,c)}}();return{init:function(){c.init(),d.init(),b.state.modal=LWA.Modules.Modal("#modal-gallery-button","#modal-gallery",{closeable:!0,open:b.init,close:b.destroy}),$(window).resize(a)}}}(),LWA.Views.Gallery.init();
